...
public class SemaphoreTable implements ISemaphoreTable {
    ...
    public SemaphoreTable() {elements = Collections.synchronizedMap(new HashMap<>()); firstFree=0;}
    ...
    public String toFile(){
        String result = "  SemaphoreTable:";
        for (Integer key : elements.keySet()) {
            result += "\n" + key + "-->" + elements.get(key).getKey()+" : "+elements.get(key).getValue();
        }
        return result;
    }
}
